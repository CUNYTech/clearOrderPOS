    ...
    return (
      <div style={contentStyle}>
        ...
        <div style={{marginTop: 24, marginBottom: 12}}>
          ...
          />
          <RaisedButton
            label={stepIndex === 2 ? 'Register Now' : 'Next'}
            primary={true}
    ...
    return (
      <div style={{width: '100%', maxWidth: 700, margin: 'auto'}}>
        <Stepper activeStep={stepIndex}>
          <Step>
            <StepLabel>Register Your Business</StepLabel>
          </Step>
          <Step>
            <StepLabel>Create a unique business ID</StepLabel>
          </Step>
          <Step>
            <StepLabel>Share with employees</StepLabel>
          </Step>
        </Stepper>
